...
public class WebSecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers(HttpMethod.GET, "/funcionarios/listarClientes").hasRole("FUNCIONARIO")
		.requestMatchers(HttpMethod.POST, "/funcionarios").hasRole("FUNCIONARIO")
		...
		.requestMatchers(HttpMethod.GET, "/login/historico").hasRole("FUNCIONARIO")
